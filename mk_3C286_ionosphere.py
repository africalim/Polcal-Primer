...
def __run_rinex_predict(LONG, LAT, HEIGHT, OBJECT, DATA_DIR, MAX_DIST, START_TIME, END_TIME, USEPIM):
    os.system('date')
...
if __name__ == "__main__":
    ...
    # USEPIM=False
    # OBJECT="MeerKat_Moon_Jun_22_UHF_3C286_IRI"
    DATA_DIR = os.path.join(__checkmake_outputdir(), 'MeerKat_3C286_test_3C286_Jun_22_UHF')
    MAX_DIST = 350E3

    __run_rinex_predict(LONG, LAT, HEIGHT, OBJECT, DATA_DIR, MAX_DIST, START_TIME, END_TIME, USEPIM)
